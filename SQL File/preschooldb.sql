...
INSERT INTO `tblenrollment` (`id`, `enrollmentNumber`, `firstName`, `surname`, `lastName`, `nationality`, `gender`, `age`, `fms`, `district`, `mobile`, `email`, `postingDate`, `enrollStatus`, `officialRemark`, `updationDate`) VALUES

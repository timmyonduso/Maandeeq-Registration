...
?>
       ...
       <tr>
                  <th>First Name</th>
                    <td colspan="3"><?php echo $result['firstName']?></td>
                  </tr>
                 ...
                 <tr>
                  ...
                  <tr>
                      ...
                      <th>CV</th>
                      <td colspan="3"><?php echo $result['cv']?></td>

                      <th>Cover Letter</th>
                      <td colspan="3"><?php echo $result['cover']?></td>
...
<button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal">Accept/Reject</button>
</td>
<?php endif;?>
